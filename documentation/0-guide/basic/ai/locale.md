...
该分支的仓库根目录已包含 `app.json`。然后在 Craft 中打包，上传到 [AIUI Studio Global](https://aiui-global.rokid.com/) 中名为 **Mav** 的 AIUI Agent，并在眼镜上执行 **Settings → Developer → AIUI → Update Glasses Resource Package**。
